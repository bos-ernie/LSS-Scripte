...
$(function() {
    ...
    function fzMain(){
        ...
        outputText = `<table id="fzTable" class="table table-dark mission_header_info table-condensed"><tr class="panel-heading"><td>Eigene Fahrzeuge</td><td>${ownVehiclesOnDrive + ownVehiclesAtMission}</td></tr>`;
    ...
    $("#amount_of_people").append(`<span id="fzCars">Fahrzeuge <span class="label label-default">${allVehiclesOnDrive + allVehiclesAtMission}</span></span>
                                   <span id="fzPlayers">Spieler <span class="label" style="background-color: dimgrey;">${ownVehiclesOnDrive + ownVehiclesAtMission != 0 ? arrNames.length + 1 : arrNames.length}</span></span>`);
