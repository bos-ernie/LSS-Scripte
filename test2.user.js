...
// @author       Lennard[TFD]; modded by Allure149 & DrTraxx
...
(function() {
    ...
    function addToForm() {
        let radius = "<div class='input-group'><div class='input-group-addon'><label for='poiGeneratorRange'>Radius (m)</label></div><input id='poiGeneratorRange' class='form-control integer' type='number' step='200' min='100' max='100000' value='1000'></div>"
